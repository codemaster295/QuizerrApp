      ...
      <div className='flex items-center justify-center'>
        <div className='h-[619px] w-[341px] bg-white text-black rounded rounded-[30px] ml-[-4px] mt-[6px]'>
          ...
          <div className='pt-[9px]'>
            <div className=' bg-black h-[8px] rounded-[30px] w-[73%] mx-auto'>
              <div style={{width:((questionIndex+1)/ questions?.length)*100+"%"}} className=' rounded-[30px] h-[8px] bg-[#4CAF50] text-center leading-[30px] text-white'></div>
            </div>
          </div>
          {questions.filter((data,index)=>index===questionIndex).map(data=>(

          <div className='pt-[40px] my-0 mx-[17px]'>
            <h4 className='text-center lowercase tracking-[0px] text-[19px] font-bold'>
              {data.question}
            </h4>
              ...
              <ul>
                {data.options?.map(data => {
                  ...
                  return (<li onClick={() => { setSelectedAnswer(data) }}
                    className={selected ? 'transition-all hover:scale-[1.03] active:scale-[0.98] transform py-[12px] flex justify-between px-[30px] mt-[3px] mr-[9px] mb-[10px] ml-[9px] rounded-[12px] border border-[#4CAF50]' :
            ...
            <a href='#' onClick={()=>{if(questionIndex+1!==questions.length){setQuestionIndex(questionIndex+1)}}} className='transition-all text-white hover:scale-[1.03] active:scale-[0.98] transform  px-[10px] py-[13px] w-[293px] rounded-[11px] block border text-center text-[17px] uppercase font-bold mx-auto mt-[20px] mb-0 bg-[#7e4ffc]'>
